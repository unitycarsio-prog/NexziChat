...
export const DoubleCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.62 16.2 7.38 12l-1.41 1.41L11.62 19l12.03-12.03L22.24 5.59zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z" />
    </svg>
);
